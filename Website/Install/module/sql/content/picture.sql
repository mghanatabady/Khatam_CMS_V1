/****** Object:  Table [dbo].[picture]    Script Date: 07/27/2010 13:06:10 ******/
SET ANSI_NULLS ON
GO
...
if NOT Exists(select * from sys.columns where Name = N'fileDL'  and Object_ID = Object_ID(N'picture')) 
begin  
 -- Column Exists 
ALTER TABLE picture ADD [fileDL] [nvarchar](255) NULL
end 
GO
