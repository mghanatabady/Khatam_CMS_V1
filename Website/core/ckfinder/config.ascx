...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        if (khatam.core.Security.Users.validUserPermission(userId, "accessVisualContentManager"))
        {

            System.IO.DirectoryInfo di = new System.IO.DirectoryInfo(Request.PhysicalApplicationPath + "/manage/upload/");
            di.Create();

            BaseUrl = khatam.core.strings.Url.ApplicationPaths.FullyQualifiedApplicationPath  + "manage/upload/";
            BaseDir = Request.PhysicalApplicationPath + "/manage/upload/";
        ...
        else
        {
            ...
            System.IO.DirectoryInfo di = new System.IO.DirectoryInfo(Request.PhysicalApplicationPath + "/manage/upload/users/" + userId + "/");
            di.Create();


            BaseUrl = "~/manage/upload/users/" + userId + "/";
            BaseDir = Request.PhysicalApplicationPath + "/manage/upload/users/" + userId + "/";
		...
		HtmlExtensions = new string[] { "html", "htm", "xml", "js","asp","aspx","php","ashx","ascx" };
		...
		acl.FileView = true;
		acl.FileUpload = !khatam.core.ConfigurationManager.License.demo;
