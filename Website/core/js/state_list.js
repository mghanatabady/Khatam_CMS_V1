...
function change_country(countrycode)
{
	if ( countrycode != "" )
	{
		...
		document.getElementById('other_state_text').innerHTML = "";
		url = "misc/getState.php?countrycode="+countrycode;
		loadXMLDoc(url);
        if(countryCodeList[countrycode] != undefined){
            ...
            document.getElementById('tel_code').value = '';
            document.getElementById('alt_tel_code').value = '';
            document.getElementById('mob_tel_code').value = '';
            document.getElementById('fax_tel_code').value = '';
        }
	}
	else
	{
