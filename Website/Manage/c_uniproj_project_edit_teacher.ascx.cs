...
public partial class Manage_c_uniproj_project_edit_teacher : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (khatam.core.data.sql.Sql_Check_identity("id", this.Request.QueryString["project_id"], "uniTeacherUserId", khatam.core.Security.Users.login().ToString(),
      "uniproj_project", khatam.core.ConfigurationManager.ConnectionStrings.ConnectionString()))
        {
        ...
        c.Text = "دانشگاه: ویرایش پروژه - استاد";
        ...
        l.Text = l.Text + " دانشگاه: ویرایش پروژه - استاد";
        l.Text = l.Text + "</span> ";


        string project_id = this.Request.QueryString["project_id"];
        
        if (this.IsPostBack == false)
        {
            Txt_Title.Text = khatam.core.data.sql.getField("title", "id", project_id, "uniproj_project");
            DropDownList1.SelectedValue = khatam.core.data.sql.getField("projectType", "id", project_id, "uniproj_project");
            txt_tag_Description.Text = khatam.core.data.sql.getField("memo", "id", project_id, "uniproj_project");
            CKEditor1.Text = khatam.core.data.sql.getField("htmlpage", "id", project_id, "uniproj_project");
    ...
    protected string update_project()
    {
        ...
        khatam.core.data.sql.update(item_name, item_value, "uniproj_project", "id", this.Request.QueryString["project_id"]);
