...
public partial class Manage_C_estate : System.Web.UI.UserControl
{
...
" FROM         coreRoleSys INNER JOIN " +
        ...
        RedirectTo(khatam.core.ConfigurationManager.ApplicationPaths.FullyQualifiedApplicationPath 
            +"manage/?mode=estate_add");
    }
