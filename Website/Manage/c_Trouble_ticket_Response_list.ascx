<%@ Control Language="VB" AutoEventWireup="false" CodeFile="c_Trouble_ticket_Response_list.ascx.vb" Inherits="manage_c_Trouble_ticket_Response_list" %>
<br />
