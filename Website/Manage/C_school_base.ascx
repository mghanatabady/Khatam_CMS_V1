<%@ Control Language="VB" AutoEventWireup="false" CodeFile="C_school_base.ascx.vb" Inherits="C_school_base_list" %>
<br />
...
<br />
<div dir="rtl" style="margin-left: 10px; width: 742px; margin-right: 10px" id="DIV1" runat="server" visible="true">
...
<div dir="rtl" style="margin-left: 10px; width: 742px; margin-right: 10px; text-align: right">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
        ...
        <Columns>
            ...
            <asp:ButtonField CommandName="school_base_del" Text="حذف" />
        </Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        SelectCommand="SELECT school_Category.title, school_branch.title AS school_branch_title, school_base_cat.title AS school_base_cat_title, school_base.id FROM school_base INNER JOIN school_Category ON school_base.id_school_Category = school_Category.id INNER JOIN school_branch ON school_Category.id_school_branch = school_branch.id INNER JOIN school_base_cat ON school_base.year_number = school_base_cat.id"></asp:SqlDataSource>
</div>
