...
public partial class Manage_C_estate_add : System.Web.UI.UserControl
{
 ...
 + " </div>";
    ...
    private void Fill_Field_Content(string type_content)
    {
        ...
        catch
        {
            ...
            DateTime showTime = new DateTime();//= DateTime.Parse( khatam.core.data.sql.getField(  "id", idpage_content, "cat")); 
