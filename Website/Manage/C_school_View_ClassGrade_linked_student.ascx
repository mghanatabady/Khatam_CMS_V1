<%@ Control Language="C#" AutoEventWireup="true" CodeFile="C_school_View_ClassGrade_linked_student.ascx.cs" Inherits="Manage_C_school_View_ClassGrade_linked_student" %>
    ...
    <div style="background-image: url(images/Form1_left_body.gif); width: 742px; background-repeat: repeat-y;
        ...
        <div style="background-image: url(images/Form1_icon_Spacer.gif); margin-left: 9px;
            ...
            <div class="from_div_maintitle ">
                <strong><span>کلاسی</span></strong></div>
        </div>
        ...
        <FooterStyle BackColor="#F1F3FA" />
                    <Columns>
                        ...
                        <asp:BoundField DataField="title" HeaderText="عنوان درس" SortExpression="title" />
                        <asp:BoundField DataField="ExamTitle" HeaderText="عنوان امتحان" SortExpression="ExamTitle" />
                        ...
                        <asp:BoundField DataField="ScoreTypeTitle" HeaderText="نوع امتحان" 
