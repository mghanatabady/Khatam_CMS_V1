...
Partial Class c_school_teacher_del
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        KUI.Database.sql.Sql_Del_Row("id", Me.Request.QueryString("id"), "school_teacher", ConfigurationManager.ConnectionStrings("Khatam_Site").ConnectionString)
        KUI.Database.sql.Sql_Del_Row("idt", Me.Request.QueryString("id"), "content", ConfigurationManager.ConnectionStrings("Khatam_Site").ConnectionString)


        del_upload_folder("school_teacher", Me.Request.QueryString("id"))
