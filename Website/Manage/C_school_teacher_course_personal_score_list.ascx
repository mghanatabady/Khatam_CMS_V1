<%@ Control Language="C#" AutoEventWireup="true" CodeFile="C_school_teacher_course_personal_score_list.ascx.cs" Inherits="Manage_C_school_teacher_course_personal_score_list" %>
<br />
