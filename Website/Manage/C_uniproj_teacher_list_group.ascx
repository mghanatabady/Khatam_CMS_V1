<%@ Control Language="C#" AutoEventWireup="true" CodeFile="C_uniproj_teacher_list_group.ascx.cs" Inherits="Manage_C_uniproj_teacher_list_group" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div dir="rtl" style="width: 992px; border: 1px solid #AEBBC0; padding-right: 1px">
                <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ظرفیت اختصاص پروژه"></asp:TemplateField>
            ...
            <asp:TemplateField>
                        ...
                        Text="ویرایش ظرفیت اختصاص پروژه اساتید"   RowIndex='<%# Container.DisplayIndex %>'  
                        onmouseout="return hideTip();"
                        OnClientClick="return hideTip();"   
                        onmouseover="return tooltip('ویرایش ظرفیت اختصاص پروژه ی اساتید','ویرایش ظرفیت','direction:rtl,width:170');" 
            ...
            <div id="msgAdd" style="width: 475px">
                    ...
                    border-bottom-width: 1px; border-bottom-color: #ecf1f3;">
                                ویرایش ظرفیت اختصاص پروژه ی استاد</div>
                    ...
                    <div style="border: 1px solid #dce7ed; width: 450px; display: inline-block; background-color: #f5f9f9;
                        ...
                        <div id="row" style="margin-top: 10px; width: 100%; display: inline-block">
                            ...
                            <div style="float: right; width: 200px; text-align: right;">                                
                                <asp:TextBox ID="edit_txt_capacity" CssClass="txt_dialog_medium_rtl" runat="server"></asp:TextBox>
                                <asp:RangeValidator ID="RangeValidator1" runat="server"  ControlToValidate="edit_txt_capacity"
                                    ErrorMessage="لطفا مقدار ظرفیت را به صورت عددی و در بازه 0 تا 1000 وارد نمایید" Text="*"
                                     Type="Integer" MinimumValue="0"  MaximumValue="1000" ValidationGroup="add"></asp:RangeValidator>
                                </div>
                        </div>
            ...
            <div id="msgLimitLowerThanTeacherUsed" style="width: 475px">
                <div style="background-color: #e2ebee; color: #282a2c; font-weight: bold; cursor: default;
                    height: 30px; padding: 10px; font-size: 12pt; text-align: right; border-bottom-style: solid;
                    border-bottom-width: 1px; border-bottom-color: #ecf1f3;">
                    ویرایش ظرفیت اختصاص پروژه ی استاد
                </div>
                <div style="background-color: White; width: 475px; display: inline-block; border-top-color: #e5e5e5;">
                    <div style="border: 1px solid #dce7ed; width: 450px; display: inline-block; background-color: #f5f9f9;
                        margin: 10px; padding-bottom: 20px">
                        ...
                        <div style="padding-right: 5px; margin-top: 5px; float: right; direction: rtl; text-align: right;
                            color: red; padding-top: 5px;">
                            <span style="color: black">عملیات ناموفق<br />
                                <span style="font-size: 9pt">استاد مورد نظر <asp:Label ID="lbl_LimitLower" runat="server" Text=""></asp:Label> 
                            پروژه تعریف نموده اند لذا ظرفیت پروژه نمی تواند از این عدد کمتر باشد.</span></span></div>
                        <br />
                    </div>
                    <div style="text-align: right; padding-right: 10px; padding-bottom: 10px">
                        <asp:Button ID="Button3" runat="server" Text="بازگشت" Width="58px" Height="31px"
                            BackColor="#9DC023" ValidationGroup="add2" Font-Bold="true" ForeColor="White"
                            BorderStyle="Solid" BorderColor="#74991A" BorderWidth="1px" 
                            Font-Names="tahoma" onclick="Button3_Click1" />
                    </div>
                </div>
            </div>

            <div id="msgLimmitFull" style="width: 475px">
                <div style="background-color: #e2ebee; color: #282a2c; font-weight: bold; cursor: default;
                    height: 30px; padding: 10px; font-size: 12pt; text-align: right; border-bottom-style: solid;
                    border-bottom-width: 1px; border-bottom-color: #ecf1f3;">
                    ویرایش ظرفیت اختصاص پروژه ی استاد
                ...
                <div style="background-color: White; width: 475px; display: inline-block; border-top-color: #e5e5e5;">
                    <div style="border: 1px solid #dce7ed; width: 450px; display: inline-block; background-color: #f5f9f9;
                        ...
                        <div style="padding-right: 5px; margin-top: 5px; float: right; direction: rtl; text-align: right;
                            color: red; padding-top: 5px;">
                            <span style="color: black">عملیات ناموفق<br />
                                <span style="font-size: 9pt">به دلیل تکمیل ظرفیت ترم، حداکثر ظرفیت اختصاصی به استاد  <asp:Label ID="lbl_LimmitFull" runat="server" Text=""></asp:Label> 
                            می باشد .</span></span></div>
                        <br />
                    </div>
                    <div style="text-align: right; padding-right: 10px; padding-bottom: 10px">
                        <asp:Button ID="Button4" runat="server" Text="بازگشت" Width="58px" Height="31px"
                            BackColor="#9DC023" ValidationGroup="add2" Font-Bold="true" ForeColor="White"
                            BorderStyle="Solid" BorderColor="#74991A" BorderWidth="1px" 
                            Font-Names="tahoma" onclick="Button3_Click1" />
                    </div>
            ...
            <cc1:ModalPopupExtender ID="UpdatePanel1_msgLimitLowerThanTeacherUsed" runat="server" BackgroundCssClass="ModalPopupBG"
                DynamicServicePath="" Enabled="True" TargetControlID="ButtonH1" PopupControlID="msgLimitLowerThanTeacherUsed">
            </cc1:ModalPopupExtender>

            <cc1:ModalPopupExtender ID="UpdatePanel1_msgLimmitFull" runat="server" BackgroundCssClass="ModalPopupBG"
                DynamicServicePath="" Enabled="True" TargetControlID="ButtonH2" PopupControlID="msgLimmitFull">
            </cc1:ModalPopupExtender>


            <asp:Label ID="trace" runat="server" Text=""></asp:Label>
