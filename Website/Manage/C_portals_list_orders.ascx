<%@ Control Language="C#" AutoEventWireup="true" CodeFile="C_portals_list_orders.ascx.cs" Inherits="Manage_C_portals_list_orders" %>
                                        ...
                                        <asp:TemplateField >
                                            <ItemTemplate  >
                                                ...
                                                <asp:ImageButton ID="btn_small_Renew" runat="server" 
                                                    ...
                                                    onmouseout="return hideTip();" 
                                                    onmouseover="return tooltip('تغییر وضعیت سرویس','تغییر وضعیت','direction:rtl,width:100');" 
