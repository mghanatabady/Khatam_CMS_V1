<%@ Control Language="VB" AutoEventWireup="false" CodeFile="c_school_teacher.ascx.vb" Inherits="c_school_teacher_list" %>
...
<div dir="rtl" style="margin-left: 10px; Width: 742px; margin-right: 10px">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
        ...
        <Columns>
            ...
            <asp:ButtonField CommandName="school_teacher_edit" Text="ویرایش" />
            <asp:ButtonField CommandName="school_teacher_del" Text="حذف" />
        </Columns>
        <EmptyDataTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Khatam_Site %>"
        DeleteCommand="DELETE FROM [teacher] WHERE [id] = @id" InsertCommand="INSERT INTO [school_teacher] ([page], [Enable]) VALUES (@page, @Enable)"
        ProviderName="<%$ ConnectionStrings:Khatam_Site.ProviderName %>" SelectCommand="SELECT [id], [Fname], [Lname], [password], [page], [Enable], [Email] FROM [school_teacher]"
        UpdateCommand="UPDATE [school_teacher] SET [page] = @page, [Enable] = @Enable WHERE [id] = @id">
        <InsertParameters>
