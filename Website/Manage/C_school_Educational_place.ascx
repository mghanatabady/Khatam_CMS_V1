<%@ Control Language="VB" AutoEventWireup="false" CodeFile="C_school_Educational_place.ascx.vb" Inherits="C_school_Educational_place_list" %>
<br />
...
<div dir="rtl" style="margin-left: 10px; width: 742px; margin-right: 10px; text-align: right;">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
        ...
        DataKeyNames="id" DataSourceID="SqlDataSource1" Width="742px" PageSize="50">
        ...
        <Columns>
            ...
            <asp:ButtonField CommandName="school_Educational_place_del" Text="حذف" Visible="False" />
        </Columns>
    </asp:GridView>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server"  SelectCommand="SELECT * FROM [school_educational_place]">
    </asp:SqlDataSource>
</div>
