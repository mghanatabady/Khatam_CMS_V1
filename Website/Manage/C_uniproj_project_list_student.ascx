<%@ Control Language="C#" AutoEventWireup="true" CodeFile="C_uniproj_project_list_student.ascx.cs" Inherits="Manage_C_uniproj_project_list_student" %>
...
<div id="divMain" runat="server"  style="width: 995px; float: right">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <HeaderStyle HorizontalAlign="Right" />
                        ...
                        <asp:BoundField DataField="uniTeacherUserId" HeaderText="کد استاد" />
                        <asp:BoundField DataField="uniTeacherUserFname" HeaderText="نام استاد" />
                        <asp:BoundField DataField="uniTeacherUserLname" HeaderText="نام خانوادگی استاد" />
                        ...
                        <asp:BoundField DataField="status"  HeaderText="وضعیت" />
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <asp:ImageButton ID="btn_small_edit" runat="server" 
                                                    ...
                                                    onmouseout="return hideTip();" 
                                                    onmouseover="return tooltip('درخواست انتخاب پروژه از استاد','درخواست پروژه','direction:rtl,width:100');" 
                                                    RowIndex="<%# Container.DisplayIndex %>" Text="درخواست پروژه"  />
                                                    ...
                                                    onmouseout="return hideTip();" 
                                                    onmouseover="return tooltip('صرفنظر از درخواست پروژه','حذف درخواست پروژه','direction:rtl,width:100');" 
                    ...
                    <div style="border: 1px solid #dce7ed; width: 450px; display: inline-block; background-color: #f5f9f9;
                        ...
                        <div style="padding-right: 5px; margin-top: 5px; float: right; direction: rtl; text-align: right;
                            ...
                            <span style="color: black">عملیات موفقیت آمیز<br />
                                <span style="font-size: 9pt">درخواست انتخاب پروژه ی شما ثبت گردید و در انتظار تایید استاد می باشد.</span></span></div>
                        <br />
                    </div>
                ...
                <div style="background-color: White; width: 475px; display: inline-block; border-top-color: #e5e5e5;">
                    <div style="border: 1px solid #dce7ed; width: 450px; display: inline-block; background-color: #f5f9f9;
                        ...
                        <div style="padding-right: 5px; margin-top: 5px; float: right; direction: rtl; text-align: right;
                            ...
                            <span style="color: black">درخواست قبلا ثبت گردیده است<br />
                                <span style="font-size: 9pt"></span></span></div>
                        <br />
                    </div>
                    <div style="text-align: right; padding-right: 10px; padding-bottom: 10px">
...
<br />
               ...
               <div style="margin-top: 5px; float: right; width: 38px; margin-right: 10px; height: 26px">
                        ...
                        <div style="padding-right: 5px; margin-top: 5px; float: right; direction:rtl ; text-align:right  ; color: red;
                            ...
                            <span style="color: black">توجه! <br />
                                <span style="font-size: 9pt">آیا برای حذف درخواست پروژه با کد 
  ...
  <div style=" text-align:right ; padding-right:10px ; padding-bottom:10px ">
        ...
        <asp:Button ID="Button21" runat="server" Font-Bold="true" Text="خیر" Width ="58px" Font-Names="tahoma"  BorderStyle="None"   />

                <asp:Button ID="Button22" runat="server"  Text="بله" Width ="58px" ValidationGroup="add2" Font-Bold="true"    
