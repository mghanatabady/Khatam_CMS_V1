<%@ Control Language="VB" AutoEventWireup="false" CodeFile="c_school_teacher_edit.ascx.vb" Inherits="c_school_teacher_edit" %>
<br />
        ...
        <div style="margin-left: 9px; width: 724px; margin-right: 9px; background-repeat: repeat-x">
            <div style="margin-top: 5px; float: left; width: 395px; margin-right: 5px; text-align: right">
                <div class="from_div_title">
                    <asp:TextBox ID="Txt_Code" runat="server" CssClass="from_txt" MaxLength="19" BackColor="#E0E0E0" ReadOnly="True"></asp:TextBox></div>
                <div class="from_div_title">
