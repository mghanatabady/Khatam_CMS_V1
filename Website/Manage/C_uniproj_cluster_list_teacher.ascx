<%@ Control Language="C#" AutoEventWireup="true" CodeFile="C_uniproj_cluster_list_teacher.ascx.cs" Inherits="Manage_C_uniproj_cluster_list_teacher" %>
            ...
            <HeaderStyle HorizontalAlign="Right" />
                        ...
                        <asp:BoundField DataField="uniGroupUserLname" 
                            HeaderText="نام خانوادگی مدیر گروه" />
                              <asp:BoundField DataField="capacity_teacher" 
                            HeaderText="ظرفیت استاد" />
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <asp:ImageButton ID="btn_small_project" runat="server" 
                                                    ...
                                                    onmouseover="return tooltip('لیست پروژه ها، ایجاد پروژه ی جدید، تایید انتخاب پروژه دانشجویان','لیست پروژه ها','direction:rtl,width:100');" 
