...
public partial class Manage_C_uniproj_project_list_group : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        c.Text = "دانشگاه: لیست پروژه ها - مدیر گروه";
        ...
        l.Text = l.Text + " دانشگاه: لیست پروژه ها - مدیر گروه";
        l.Text = l.Text + "</span> ";
    ...
    void gridBind()
    {
        string sqlstr = "    SELECT     id, title, uniTeacherUserId, uniTeacherUserFname, uniTeacherUserLname, uniProjTeacherCode, uniStudentUserId, uniStrudentFname, uniStudentLname,  regDatetime, updateDatetime ,GroupUserIdVerificationState ,DepartementUserIdVerficationState " +
                    " FROM         uniproj_project  where (clusterId = N'" + this.Request.QueryString["cluster_id"] + "') and (sendToGroupId=1) " +
                    //" ORDER BY id DESC  " +
    ...
    {
        khatam.core.data.sql.updateField("GroupUserIdVerificationState", ddl_status.SelectedValue, "id", hiddenField.Value, "uniproj_project");
        gridBind();
    }
    ...
    protected void btn_small_avtice_Click(object sender, ImageClickEventArgs e)
    {
        ...
        hiddenField.Value = str_id;
        ddl_status.SelectedValue = khatam.core.data.sql.getField( "GroupUserIdVerificationState", "id", hiddenField.Value, "uniproj_project");
