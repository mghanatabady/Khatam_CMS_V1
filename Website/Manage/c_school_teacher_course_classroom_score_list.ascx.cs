...
public partial class manage_c_school_teacher_course_classroom_score_list : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       bool   pAll=false  ,pTeacher=false ;
        ...
        if (pAll== false  )
        {
            if (khatam.School.teacher.ValidClassroomSelectRelatedTeacher(Request.QueryString["id"]) ==false ) 
                this.Response.Redirect("~/manage/?mode=msgPermisson");
