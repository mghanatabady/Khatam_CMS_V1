<%@ Control Language="C#" AutoEventWireup="true" CodeFile="C_uniproj_project_list_group.ascx.cs" Inherits="Manage_C_uniproj_project_list_group" %>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <asp:ImageButton ID="btn_small_edit" runat="server" 
                                                ...
                                                <asp:ImageButton ID="btn_small_del" runat="server" 
                                                    ...
                                                    RowIndex="<%# Container.DisplayIndex %>" Text="حذف"  Visible="false" />
                                                    ...
                                                    onmouseout="return hideTip();" 
                                                    onmouseover="return tooltip('تایید/لغو پروژه - کارشناس پژوهش','بروز رسانی وضعیت تایید پروژه','direction:rtl,width:200');" 
           ...
           />
            ...
            <div id="msgStatus" style="width: 475px">
                ...
                <div style="background-color: White; width: 475px; display: inline-block; border-top-color: #e5e5e5;">
                    ...
                    <div style="text-align: right; padding-right: 10px; padding-bottom: 10px">
                        <asp:Button ID="Button3" runat="server" Font-Bold="true" Text="انصراف" Width="88px" Font-Names="tahoma" BorderStyle="None" />
                        <asp:Button ID="Button4" runat="server" Text="تایید" Width="88px" Font-Bold="true" BorderStyle="None" Font-Names="tahoma" OnClick="Button_status_ok_Click" OnClientClick="  this.value = 'بروز رسانی...'; this.style.background = 'silver';" />
                    </div>
                </div>
            </div>
