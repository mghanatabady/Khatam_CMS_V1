<%@ Control Language="VB" AutoEventWireup="false" CodeFile="C_school_Category_Add.ascx.vb" Inherits="C_school_Category_Add" %>
<br />
    ...
    <div style="background-image: url(images/Form1_left_body.gif); width: 742px; background-repeat: repeat-y;
        ...
        <div style="background-image: url(images/Form1_icon_Spacer.gif); margin-left: 9px;
            ...
            <div style="margin-top: 15px; float: left; margin-left: 5px; width: 150px; height: 26px">
                <strong><span>مشخصات رشته</span></strong></div>
        </div>
        <div style="margin-left: 9px; width: 724px; margin-right: 9px; background-repeat: repeat-x">
            <div style="margin-top: 5px; float: left; width: 395px; margin-right: 5px; text-align: right">
                <div class="from_div_title">
                             <asp:DropDownList ID="DropDownList1" runat="server" CssClass="from_txt" Width="165px" DataSourceID="SqlDataSource1" DataTextField="title" DataValueField="id">
                    </asp:DropDownList><asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                 SelectCommand="SELECT [id], [title] FROM [school_branch]"></asp:SqlDataSource>
                    </div>
                <div class="from_div_title">
           
                    <asp:TextBox ID="Txt_Category_title" runat="server" CssClass="from_txt"></asp:TextBox></div>
            </div>
            <div style="margin-top: 5px; width: 320px">
                <div dir="rtl" class="from_div_title">
                    <span class="from_div_title">
                        تحصیلی شاخه</span></div>
                <div class="from_div_title">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="Txt_Category_title"
                        ErrorMessage="*" ValidationGroup="Teacher_Add"></asp:RequiredFieldValidator>رشته
                </div>
            </div>
        </div>
    </div>
