<%@ Control Language="C#" AutoEventWireup="true" CodeFile="C_uniproj_cluster_list_group.ascx.cs" Inherits="Manage_C_uniproj_cluster_list_group" %>
            ...
            <HeaderStyle HorizontalAlign="Right" />
                        ...
                        <asp:BoundField DataField="uniproj_eduGroup_title" HeaderText="گروه آموزشی" />
                            ...
                            HeaderText="ظرفیت" />
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                            <asp:ImageButton ID="btn_small_project" runat="server" 
                                                    ImageUrl="~/core/themeCP/Bitrix/CssImage/btn/btn_small_uniProject.gif" 
                                                    onclick="btn_small_project_Click" OnClientClick="return hideTip();" 
                                                    onmouseout="return hideTip();" 
                                                    onmouseover="return tooltip('تایید پروژه ی اساتید، حذف پروژه','مدیریت پروژه ها','direction:rtl,width:100');" 
                                                    RowIndex="<%# Container.DisplayIndex %>" Text="ویرایش" />
                                            
        

                                                <asp:ImageButton ID="btn_small_teachers" runat="server" 
                                                    ImageUrl="~/core/themeCP/Bitrix/CssImage/btn/btn_small_users.gif" 
                                                    onclick="btn_small_teachers_Click" OnClientClick="return hideTip();" 
                                                    onmouseout="return hideTip();" 
                                                    onmouseover="return tooltip('مدیریت ظرفیت اختصاص پروژه اساتید','لیست اساتید','direction:rtl,width:100');" 
                ...
                <div style="background-color: White; width: 475px; display: inline-block; border-top-color: #e5e5e5;">
                    ...
                    <div style="border: 1px solid #dce7ed; width: 450px; display: inline-block; background-color: #f5f9f9;
                        ...
                        <div id="Div7" style="margin-top: 10px; width: 100%; display: inline-block">
                            ...
                            <div style="float: right; width: 200px; text-align: right; direction: rtl">
                                <asp:TextBox ID="add_txt_capacity" CssClass="txt_dialog_medium_ltr" runat="server"></asp:TextBox></div>
                        </div>
                    ...
                    <div style="border: 1px solid #dce7ed; width: 450px; display: inline-block; background-color: #f5f9f9;
                        ...
                        <div id="Div20" style="margin-top: 10px; width: 100%; display: inline-block">
                            ...
                            <div style="float: right; width: 120px; text-align: left; padding-left: 5px">
                                ظرفیت</div>
                            <div style="float: right; width: 200px; text-align: right; direction: rtl">
                                    از <asp:TextBox ID="filter_txt_price_from" CssClass="txt_dialog_medium_ltr txt_number" runat="server"></asp:TextBox>
<br />
                                    تا <asp:TextBox ID="filter_txt_price_to" CssClass="txt_dialog_medium_ltr txt_number" runat="server"></asp:TextBox>
                            </div>
                         </div>
      ...
      <asp:ValidationSummary ID="ValidationSummary4" runat="server" 
          ValidationGroup="filter" />
                    ...
                    <div style="text-align: right; padding-right: 10px; padding-bottom: 10px">
                        ...
                        <asp:Button ID="Button_filter_ok" runat="server" Text="تایید" Width="88px" Font-Bold="true" BorderStyle="None" Font-Names="tahoma" OnClick="Button_filter_ok_Click" OnClientClick="if (Page_ClientValidate('filter')){   this.value = 'بروز رسانی...'; this.style.background = 'silver';};" />
                    </div>
                </div>
            </div>
