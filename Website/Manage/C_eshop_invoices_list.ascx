<%@ Control Language="C#" AutoEventWireup="true" CodeFile="C_eshop_invoices_list.ascx.cs" Inherits="Manage_C_shop_invoices_list" %>
...
<br />
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:BoundField DataField="users_id" HeaderText="کد کاربر" 
                SortExpression="users_id" />
            ...
            <asp:BoundField DataField="orderDate" HeaderText="زمان ثبت" 
                SortExpression="orderDate" />
            <asp:BoundField DataField="total_order_price" HeaderText="مبلغ کل" 
                SortExpression="total_order_price" />


                            <asp:BoundField DataField="payStatus" HeaderText="وضعیت پرداخت" 
                SortExpression="payStatus"  />
                         <asp:BoundField DataField="sendStatus" HeaderText="وضعیت ارسال" 
                SortExpression="sendStatus"  />

        
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                            <asp:ImageButton ID="btn_small_invoice" runat="server" 
                                                    ImageUrl="~/core/themeCP/Bitrix/CssImage/btn/btn_small_invoice.gif" 
                                                    onclick="btn_small_invoice_Click" OnClientClick="return hideTip();" 
                                                    onmouseout="return hideTip();" 
                                                    onmouseover="return tooltip('نمایش فاکتور','نمایش','direction:rtl,width:100');" 
                                                    RowIndex="<%# Container.DisplayIndex %>" Text="نمایش فاکتور" />
                                            
                                             <asp:ImageButton ID="btn_small_invoice_user" runat="server" 
                                                    ImageUrl="~/core/themeCP/Bitrix/CssImage/btn/btn_small_invoice_user.gif" 
                                                    onclick="btn_small_invoice_user_Click" OnClientClick="return hideTip();" 
                                                    onmouseout="return hideTip();" 
                                                    onmouseover="return tooltip('تغییر کاربر مرتبط با فاکتور','تغییر کاربر','direction:rtl,width:100');" 
                                                    RowIndex="<%# Container.DisplayIndex %>" Text="تغییر کاربر مرتبط با فاکتور" />
                                                ...
                                                <asp:ImageButton ID="btn_small_del" runat="server" 
                                                    ...
                                                    onmouseout="return hideTip();" 
                                                    onmouseover="return tooltip('حذف فاکتور','حذف','direction:rtl,width:100');" 
                                                    RowIndex="<%# Container.DisplayIndex %>" Text="حذف" />

                                                    <asp:ImageButton ID="btn_small_status" runat="server" 
                                                    ImageUrl="~/core/themeCP/Bitrix/CssImage/btn/btn_small_status.gif" 
                                                    onclick="btn_small_status_Click" OnClientClick="return hideTip();" 
                                                    onmouseout="return hideTip();" 
                                                    onmouseover="return tooltip('تغییر وضعیت ارسال','تغییر وضعیت','direction:rtl,width:100');" 
                                                    RowIndex="<%# Container.DisplayIndex %>" Text="تغییر وضعیت" />
                  ...
                  ControlToValidate="add_txt_email"
                        ...
                        <div id="Div16" style="margin-top: 10px; width: 100%; display: inline-block">
                            ...
                            <div style="float: right; width: 200px; text-align: right; direction: rtl">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="SELECT * FROM [coreRole]">
                                </asp:SqlDataSource>
                            </div>
                        </div>
    ...
    <div style=" border: 1px solid #dce7ed;width :450px ;  display:inline-block   ;background-color:#f5f9f9; margin:10px ; padding-bottom:20px">
               ...
               <div style="margin-top: 5px; float: right; width: 38px; margin-right: 10px; height: 26px">
                        ...
                        <div style="padding-right: 5px; margin-top: 5px; float: right; direction:rtl ; text-align:right  ; color: red;
                            ...
                            <span style="color: black">توجه! با حذف فاکتور کارت مرتبط با آن حذف می گردد<br />
                                <span style="font-size: 9pt">آیا برای حذف فاکتور با کد 
           ...
           />
            ...
            <div id="msgEdit" style="width: 475px">
                ...
                <div style="background-color: White; width: 475px; display: inline-block; border-top-color: #e5e5e5;">
                    ...
                    <div style="border: 1px solid #dce7ed; width: 450px; display: inline-block; background-color: #f5f9f9;
                        margin: 10px; padding-bottom: 20px">
                        <div id="Div52" style="margin-top: 10px; width: 100%; display: inline-block">
                            <div style="float: right; width: 120px; text-align: left; padding-left: 5px">
                                نام</div>
                            <div style="float: right; width: 200px; text-align: right;">
                                <asp:TextBox ID="TextBox25" CssClass="txt_dialog_medium_rtl" runat="server"></asp:TextBox></div>
                        </div>
                        <div id="Div53" style="margin-top: 10px; width: 100%; display: inline-block">
                            <div style="float: right; width: 120px; text-align: left; padding-left: 5px">
                                نام خانوادگی<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                    ControlToValidate="add_txt_lname" ValidationGroup="add" ErrorMessage="لطفا نام خانوادگی را درج نمایید">*</asp:RequiredFieldValidator></div>
                            <div style="float: right; width: 200px; text-align: right">
                                <asp:TextBox ID="TextBox26" CssClass="txt_dialog_medium_rtl" runat="server"></asp:TextBox></div>
                        </div>
                        <div id="Div54" style="margin-top: 10px; width: 100%; display: inline-block">
                            <div style="float: right; width: 120px; text-align: left; padding-left: 5px">
                                شرکت / موسسه</div>
                            <div style="float: right; width: 200px; text-align: right">
                                <asp:TextBox ID="TextBox27" CssClass="txt_dialog_medium_rtl" runat="server"></asp:TextBox></div>
                        </div>
                        <div id="Div55" style="margin-top: 10px; width: 100%; display: inline-block">
                            <div style="float: right; width: 120px; text-align: left; padding-left: 5px">
                                تلفن<a class="tooltipA" href="#" onclick="return false;" onmouseout="return hideTip();"
                                    onmouseover="return tooltip('همراه با کد شهر');">[?]</a></div>
                            <div style="float: right; width: 200px; text-align: right; direction: rtl">
                                <asp:TextBox ID="TextBox28" CssClass="txt_dialog_medium_ltr" runat="server"></asp:TextBox></div>
                        </div>
                        <div id="Div56" style="margin-top: 10px; width: 100%; display: inline-block">
                            <div style="float: right; width: 120px; text-align: left; padding-left: 5px">
                                فکس<a class="tooltipA" href="#" onclick="return false;" onmouseout="return hideTip();"
                                    onmouseover="return tooltip('همراه با کد شهر');">[?]</a></div>
                            <div style="float: right; width: 200px; text-align: right; direction: rtl">
                                <asp:TextBox ID="TextBox29" CssClass="txt_dialog_medium_ltr" runat="server"></asp:TextBox></div>
                        </div>
                        <div id="Div57" style="margin-top: 10px; width: 100%; display: inline-block">
                            <div style="float: right; width: 120px; text-align: left; padding-left: 5px">
                                موبایل<a class="tooltipA" href="#" onclick="return false;" onmouseout="return hideTip();"
                                    onmouseover="return tooltip('به صورت 11 رقمی مانند: 09127710277');">[?]</a></div>
                            <div style="float: right; width: 200px; text-align: right; direction: rtl">
                                <asp:TextBox ID="TextBox30" CssClass="txt_dialog_medium_ltr" runat="server"></asp:TextBox></div>
                        </div>
                        <div id="Div58" style="margin-top: 10px; width: 100%; display: inline-block">
                            <div style="float: right; width: 120px; text-align: left; padding-left: 5px">
                                کشور</div>
                            <div style="float: right; width: 200px; text-align: right; direction: rtl">
                                <asp:TextBox ID="TextBox31" CssClass="txt_dialog_medium_rtl" runat="server"></asp:TextBox></div>
                        </div>
                        <div id="Div59" style="margin-top: 10px; width: 100%; display: inline-block">
                            <div style="float: right; width: 120px; text-align: left; padding-left: 5px">
                                استان / ایالت</div>
                            <div style="float: right; width: 200px; text-align: right; direction: rtl">
                                <asp:TextBox ID="TextBox32" CssClass="txt_dialog_medium_rtl" runat="server"></asp:TextBox></div>
                        </div>
                        <div id="Div60" style="margin-top: 10px; width: 100%; display: inline-block">
                            <div style="float: right; width: 120px; text-align: left; padding-left: 5px">
                                شهر</div>
                            <div style="float: right; width: 200px; text-align: right; direction: rtl">
                                <asp:TextBox ID="TextBox33" CssClass="txt_dialog_medium_rtl" runat="server"></asp:TextBox></div>
                        </div>
                        <div id="Div61" style="margin-top: 10px; width: 100%; display: inline-block">
                            <div style="float: right; width: 120px; text-align: left; padding-left: 5px">
                                آدرس</div>
                            <div style="float: right; width: 200px; text-align: right; direction: rtl">
                                <asp:TextBox ID="TextBox34" CssClass="txt_dialog_large_rlt" runat="server"></asp:TextBox></div>
                        </div>
                        <div id="Div62" style="margin-top: 10px; width: 100%; display: inline-block">
                            <div style="float: right; width: 120px; text-align: left; padding-left: 5px">
                                کدپستی</div>
                            <div style="float: right; width: 200px; text-align: right; direction: rtl">
                                <asp:TextBox ID="TextBox35" CssClass="txt_dialog_medium_ltr" runat="server"></asp:TextBox></div>
                        </div>
                        <div id="Div63" style="margin-top: 10px; width: 100%; display: inline-block">
                            <div style="float: right; width: 120px; text-align: left; padding-left: 5px">
                                ایمیل<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="add_txt_email"
                                    ValidationGroup="add" ErrorMessage="لطفا ایمیل کاربر را درج نمایید">*</asp:RequiredFieldValidator><a
                                        class="tooltipA" href="#" onclick="return false;" onmouseout="return hideTip();"
                                        onmouseover="return tooltip('ایمیل معتبر');">[?]</a></div>
                            <div style="float: right; width: 200px; text-align: right; direction: rtl">
                                <asp:TextBox ID="TextBox36" CssClass="txt_dialog_medium_ltr" runat="server"></asp:TextBox></div>
                        </div>
                        <div id="Div64" style="margin-top: 10px; width: 100%; display: inline-block">
                            <div style="float: right; width: 120px; text-align: left; padding-left: 5px">
                                کلمه عبور<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server"
                                    ControlToValidate="add_txt_password" ValidationGroup="add" ErrorMessage="لطفا کلمه عبور را درج نمایید">*</asp:RequiredFieldValidator></div>
                            <div style="float: right; width: 200px; text-align: right; direction: rtl">
                                <asp:TextBox ID="TextBox37" CssClass="txt_dialog_medium_ltr" TextMode="Password"
                                    runat="server"></asp:TextBox></div>
                        </div>
                        <div id="Div65" style="margin-top: 10px; width: 100%; display: inline-block">
                            <div style="float: right; width: 120px; text-align: left; padding-left: 5px">
                                گروه کاربری</div>
                            <div style="float: right; width: 200px; text-align: right; direction: rtl">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource4" runat="server" SelectCommand="SELECT * FROM [coreRole]">
                                </asp:SqlDataSource>
                            </div>
                        </div>
