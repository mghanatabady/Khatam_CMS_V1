<%@ Control Language="C#" AutoEventWireup="true" CodeFile="C_eshop_trasactions_online_all.ascx.cs" Inherits="Manage_C_shop_trasactions_online_all" %>
...
<asp:SqlDataSource ID="SqlDataSource2" runat="server" 
    ...
    SelectCommand="SELECT sbt.* FROM sbt ORDER BY resnum DESC" 
