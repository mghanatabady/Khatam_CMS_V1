<%@ Control Language="VB" AutoEventWireup="false" CodeFile="c_school_form_registration_request_list2.ascx.vb" Inherits="c_school_form_registration_request_list2" %>
...
<div dir="rtl" style="margin-left: 10px; width: 742px; margin-right: 10px; text-align: justify;">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
        ...
        DataKeyNames="idreg" DataSourceID="SqlDataSource1" Width="742px" PageSize="25">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="realname" HeaderText="نام و نام خانوادگی" SortExpression="realname">
                <ItemStyle Width="250px" />
            </asp:BoundField>
            <asp:BoundField DataField="datetime" HeaderText="زمان درج" SortExpression="datetime">
                <ItemStyle Width="250px" />
            </asp:BoundField>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Khatam_Site %>"
        ProviderName="<%$ ConnectionStrings:Khatam_Site.ProviderName %>" SelectCommand="SELECT idreg, Fname + ' ' + Lname AS realname, datetime FROM school_form_registration_request2 ORDER BY idreg DESC" DeleteCommand="DELETE FROM message WHERE (idm = @idm)">
        <DeleteParameters>
