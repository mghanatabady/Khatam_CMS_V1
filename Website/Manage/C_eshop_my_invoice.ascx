<%@ Control Language="C#" AutoEventWireup="true" CodeFile="C_eshop_my_invoice.ascx.cs" Inherits="Manage_C_shop_my_invoice" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
    <div dir="rtl" id="div2222" runat="server" visible="false"  >
...
<div  dir="rtl"  style=" width: 100%;   ">
    &nbsp;<asp:GridView 
        ...
        <Columns>
            ...
            <asp:ButtonField Text="نمایش" CommandName="pay" />
        </Columns>
        <EmptyDataTemplate>
