<%@ Control Language="VB" AutoEventWireup="false" CodeFile="c_school_teacher_course_classroom_list.ascx.vb" Inherits="manage_c_school_teacher_course_classroom_list" %>
...
FROM         school_Class INNER JOIN
    ...
    <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
        ...
        <Columns>
            ...
            <asp:ButtonField CommandName="select" Text="نمایش نمره" />
        </Columns>
        <FooterStyle BackColor="#F1F3FA" />
        <EmptyDataTemplate>
            هیچ درسی برای ویرایش یافت نگردید.
