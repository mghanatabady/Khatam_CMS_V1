...
Partial Class manage_c_trouble_ticket_request_item
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Me.GridView2.Rows(0).BackColor = Drawing.ColorTranslator.FromHtml("#EFF3FB")
    End Sub
    Private Sub bind_grid1()
        ...
        For i = 0 To Me.GridView2.Rows.Count - 1
            If Me.GridView3.Rows(i).Cells(1).Text = "1" Then
                CType(Me.GridView2.Rows(i).Cells(0).FindControl("Lbl_RealName"), Label).Text = Me.Session("realname")
            Else
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Me.GridView4.Rows.Count > 0 Then
            ...
            If Me.CheckBox1.Checked = False Then
                ...
                support_ticker_note_add(status)


            Else
                status = 4
                support_ticket_status_update(Me.Request.QueryString("id"), status)
                support_ticker_note_close(status)
    ...
    Private Sub support_ticker_note_add(ByVal status As Integer)
        ...
        support_ticket_line_add(Me.Request.QueryString("id"), html_liner(Me.Txt_Page.Text), status, 1, date_now)
...
10:
        ...
        EmailSender_Support(get_customer_email(Me.Session("user_id")), "Email_support_update.htm", domain_str & ": Updated Support Request Ticket No: " & Me.Request.QueryString("id"), "", Me.Session("realname"), Me.Request.QueryString("id"), "موضوع", GridView4.Rows(0).Cells(2).Text, persian_datetime_insert, persian_datetime_now, ticket_body)

    End Sub

    Private Sub support_ticker_note_close(ByVal status As Integer)
...
20:
        ...
        EmailSender_Support(get_customer_email(Me.Session("user_id")), "Email_support_close.htm", domain_str & ": Closed Support Request Ticket No: " & Me.Request.QueryString("id"), "", Me.Session("realname"), Me.Request.QueryString("id"), "موضوع", GridView4.Rows(0).Cells(2).Text, persian_datetime_insert, persian_datetime_now, ticket_body)
    ...
    Function ticket_atacht_body(ByVal site As String, ByVal id_ticket As String, ByVal id_ticket_line As String) As String
        ...
        'str_sql = "SELECT    file_path , file_name  FROM         trouble_Ticket_File   WHERE     (id_ticket = 4) AND (id_ticket_line = 7)"
