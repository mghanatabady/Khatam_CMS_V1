...
public partial class Manage_C_host_my_orders : System.Web.UI.UserControl
{
...
" WHERE     (core_invoice_line.type_content = N'host') AND (core_invoice.users_id = " + khatam.core.Security.Users.login() + ") " + ViewState["strWhere"] + ViewState["strOrderBy"];
