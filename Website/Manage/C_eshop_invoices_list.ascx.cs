...
public partial class Manage_C_shop_invoices_list : System.Web.UI.UserControl
{
    ...
    void gridBind()
    {
        string sqlstr = "SELECT     core_invoice.id, core_invoice.payStatus, core_invoice.sendStatus, core_invoice.orderDate, core_invoice.total_order_price, core_invoice.users_id, users.fname,  users.lname FROM         core_invoice  LEFT OUTER  JOIN           users ON core_invoice.users_id = users.id " +
