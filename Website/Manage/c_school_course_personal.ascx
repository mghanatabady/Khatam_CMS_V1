<%@ Control Language="VB" AutoEventWireup="false" CodeFile="c_school_course_personal.ascx.vb" Inherits="c_school_course_personal_list" %>
                    ...
                    <div style="Width: 295px">
                        ...
                        <asp:TextBox ID="Txt_Search" runat="server" Font-Names="Tahoma" Font-Size="10pt"
                            Width="127px"></asp:TextBox>&nbsp;<asp:DropDownList ID="DDL_Search" runat="server"
                                ...
                                <asp:ListItem Value="2">تعداد واحد</asp:ListItem>
...
<div dir="rtl" style="margin-left: 10px; Width: 742px; margin-right: 10px; text-align: right;">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
        ...
        <Columns>
            <asp:BoundField DataField="id" HeaderText="کد ارائه" InsertVisible="False" ReadOnly="True"
                SortExpression="id" />
            <asp:BoundField DataField="school_teacher_id" HeaderText="کد معلم" SortExpression="school_teacher_id" />
            <asp:BoundField DataField="realname" HeaderText="معلم" ReadOnly="True" SortExpression="realname" />
            <asp:BoundField DataField="school_educational_place_id" HeaderText="کد فضای آموزشی"
                SortExpression="school_educational_place_id" />
            <asp:BoundField DataField="school_educational_place_title" HeaderText="فضای آموزشی"
                SortExpression="school_educational_place_title" />
            <asp:BoundField DataField="school_lesson_id" HeaderText="کد درس" SortExpression="school_lesson_id" />
            <asp:BoundField DataField="school_Lesson_title" HeaderText="درس" SortExpression="school_Lesson_title" />
            <asp:ButtonField CommandName="school_course_personal_del" Text="حذف" />
        </Columns>
        <EmptyDataTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        DeleteCommand="DELETE FROM [teacher] WHERE [id] = @id" InsertCommand="INSERT INTO [teacher] ([page], [Enable]) VALUES (@page, @Enable)"
         SelectCommand="SELECT     school_course_personal.id, school_course_personal.school_teacher_id, school_course_personal.school_educational_place_id, 
                      school_course_personal.school_lesson_id, school_educational_place.id AS school_educational_place_id, 
                      school_educational_place.title AS school_educational_place_title, school_Lesson.id AS school_Lesson_id, school_Lesson.title AS school_Lesson_title, 
                      users.lname + ' , ' + users.fname AS realname, school_Lesson.year_present
FROM         school_course_personal INNER JOIN
                      school_educational_place ON school_course_personal.school_educational_place_id = school_educational_place.id INNER JOIN
...
WHERE     school_course_personal.school_year_id in (SELECT     memo  FROM         Setting_Base  WHERE     (cname = N'school_active_year'))">
        <InsertParameters>
