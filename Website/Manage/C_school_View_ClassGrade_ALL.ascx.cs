...
public partial class Manage_C_school_View_ClassGrade_ALL : System.Web.UI.UserControl
{
...
+ " school_Lesson.unit, school_score_cat.title AS ScoreTypeTitle, users_A.id AS studentID, users_A.fname + ' ' + users_A.lname AS realname,school_score.baseOfScore"
...
+ " school_Lesson_1.unit, school_score_cat_1.title AS ScoreTypeTitle, users_2.id AS studentID, users_2.fname + ' ' + users_2.lname AS realname,school_score_1.baseOfScore"
