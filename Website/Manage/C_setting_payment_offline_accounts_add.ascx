<%@ Control Language="VB" AutoEventWireup="false" CodeFile="C_setting_payment_offline_accounts_add.ascx.vb" Inherits="manage_C_setting_payment_offline_accounts_add" %>
<br />
