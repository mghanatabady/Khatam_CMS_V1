...
public partial class Manage_C_uniproj_cluster_list_teacher : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        c.Text = "دانشگاه: لیست ظرفیت های اخصاص پروژه - استاد";
...
"                        uniproj_ClusterRefTeacher.capacity AS capacity_teacher,uniproj_sections.title AS sections_title " +
   ...
   "                     uniproj_sections ON uniproj_cluster.uniSection = uniproj_sections.id INNER JOIN " +
      "                  uniproj_year ON uniproj_cluster.year_id = uniproj_year.id INNER JOIN " +
         "               uniproj_termType ON uniproj_cluster.termType = uniproj_termType.id INNER JOIN " +
            "            uniproj_eduGroup ON uniproj_cluster.EduGroupId = uniproj_eduGroup.id INNER JOIN " +
               "         uniproj_ClusterRefTeacher ON uniproj_cluster.id = uniproj_ClusterRefTeacher.cluster_id  " +
               " WHERE     (uniproj_ClusterRefTeacher.uniTeacherId = N'" + khatam.core.Security.Users.login().ToString() + "') " +
    ...
    protected void btn_small_project_Click(object sender, ImageClickEventArgs e)
    {
        ...
        RedirectTo("~/manage/?mode=uniproj_project_list_teacher&id=" + str_id);
