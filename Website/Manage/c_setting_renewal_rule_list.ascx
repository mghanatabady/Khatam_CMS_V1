<%@ Control Language="VB" AutoEventWireup="false" CodeFile="c_setting_renewal_rule_list.ascx.vb" Inherits="manage_c_setting_renewal_rule_list" %>
...
<div dir="rtl" style="margin-left: 10px; Width: 742px; margin-right: 10px">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="price_rls" HeaderText="price_rls" 
                SortExpression="price_rls" />
            <asp:ButtonField CommandName="edit" Text="ویرایش" />
            <asp:ButtonField CommandName="del" Text="حذف" />
            <asp:ButtonField CommandName="select" Text="نمایش" />
        </Columns>
        <EmptyDataTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Khatam_site %>"
        ...
        SelectCommand="SELECT * FROM [setting_renewal_rule]">
    </asp:SqlDataSource>
</div>
