<%@ Control Language="C#" AutoEventWireup="true" CodeFile="C_Page_Edit.ascx.cs" Inherits="Manage_C_Page_Edit" %>
<%@ Register Assembly="KhatamSDRADCORE" Namespace="khatam.core.UI.baseControl" TagPrefix="cc1" %>

<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>

<%@ Register Assembly="DNA.UI.JQuery" Namespace="DNA.UI.JQuery" TagPrefix="DotNetAge" %>
<%@ Register Src="~/Manage/c_page_edit_pictureGalley.ascx" TagPrefix="uc1" TagName="c_page_edit_pictureGalley" %>
...
<div style="width: 995px; float: right">
    ...
    <div id="MSG_OK" runat="server" dir="rtl" style="border-right: teal 2px solid; border-top: teal 2px solid; margin-left: 96px; border-left: teal 2px solid; width: 652px; margin-right: 10px; border-bottom: teal 2px solid; height: 45px; text-align: right"
        visible="false">
        ...
        <div style="padding-right: 5px; margin-top: 5px; float: right; width: 493px; color: red; padding-top: 5px; height: 26px">
            <span style="color: black">عملیات موفقیت آمیز<br />
                <span style="font-size: 9pt">مشخصات مورد نظر شما ثبت گردید.</span></span>
        </div>
        <br />
    </div>
    ...
    <DotNetAge:Tabs ID="Tabs1" runat="server" AsyncLoad="true" EnabledContentCache="true">
        <Views>
            <DotNetAge:View Text="اطلاعات محتوا" runat="server" ID="View">
                ...
                <div style="background-image: url(../core/themeCP/Bitrix/CssImage/background/Form1_icon_Spacer.gif); margin-left: 9px; width: 934px; margin-right: 9px; background-repeat: repeat-x; height: 47px; overflow: auto; margin-bottom: 10px">
                    ...
                    <div style="margin-top: 15px; float: right; margin-left: 5px; width: 450px; height: 26px; color: #494949">
                        <strong><span>لطفا اطلاعات فرم زیر را با دقت کامل کنید:</span></strong>
                    </div>
                </div>
                <div style="width: 954px;" id="Div_Main" runat="server">

                    <div style="background-color: #e0e4f1; margin-left: 9px; margin-bottom: 10px; width: 934px; margin-right: 9px; padding-top: 5px; font-weight: bold; text-align: center; padding-bottom: 5px; overflow: hidden; color: #525355">
                    ...
                    <div style="background-color: #e0e4f1; margin-left: 9px; margin-bottom: 10px; margin-top: 10px; width: 934px; margin-right: 9px; padding-top: 5px; font-weight: bold; text-align: center; padding-bottom: 5px; overflow: hidden; color: #525355">
                        ویرایش اطلاعات پایه
                    </div>
                  ...
                  <!--      <div class="row">
                            <div class="field">
                                ...
                                میزان اهمیت<a href="#" class="tooltipA" onmouseover="return tooltip('بصورت عددی - عدد یک کمترین اهمیت و عدد 1000 بیشترین اهمیت');" onmouseout="return hideTip();" onclick="return false;">[?]</a>
                            </div>
                            <div class="fieldInputArea">
                                <asp:TextBox ID="TextBox2" runat="server" CssClass="txtBox" MaxLength="149" Width="250px"></asp:TextBox>
                      ...
                      -->
                        ...
                        <!--
                          <div id="div1" class="row" runat="server">
                            <div class="field">
                                <asp:RangeValidator ID="RangeValidator3" runat="server" ErrorMessage=" فیلد تاریخ در قسمت زمان نمایش را را با فرمت صحیح تاریخ درج نمایید مانند:format: 1390/12/30  "
                                    ControlToValidate="txt_birthday" Text="*" ValidationGroup="SaveAll" MaximumValue="2012/12/30" MinimumValue="1012/1/1"
                                    Type="Date"></asp:RangeValidator>


                                <asp:RequiredFieldValidator ID="RequiredFieldValidator14" ControlToValidate="txt_birthday" runat="server" ValidationGroup="SaveAll" Text="*" ErrorMessage="درج فیلد تاریخ در قسمت زمان نمایش ضروری است"></asp:RequiredFieldValidator>
                                تاریخ انقضا - نمایش به صورت آرشیو 
                            </div>
                            <div class="fieldInputArea">

                                <asp:TextBox ID="TextBox1" CssClass="txt_dialog_medium_ltr" runat="server"></asp:TextBox>
                ...
                <div style="margin-left: 9px; width: 724px; margin-right: 9px; background-repeat: repeat-x"
                    ...
                    <div style="margin-top: 5px; float: left; width: 505px; margin-right: 5px; text-align: right">
                        ...
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Link1" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Link2" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Link3" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Crack1" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Crack2" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_BuilderSite" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <br />
                    </div>
                ...
                <div style="margin-left: 9px; width: 724px; margin-right: 9px; background-repeat: repeat-x"
                    ...
                    <div style="margin-top: 5px; float: left; width: 505px; margin-right: 5px; text-align: right">
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Clip_Password" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Clip_Link1" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Clip_Link2" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Clip_Link3" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <br />
                    </div>
                    <div style="margin-top: 5px; width: 205px">
                ...
                <div style="margin-left: 9px; width: 724px; margin-right: 9px; background-repeat: repeat-x"
                    ...
                    <div style="margin-top: 5px; float: left; width: 505px; margin-right: 5px; text-align: right">
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Mobile_password" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Mobile_Link1" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Mobile_Link2" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Mobile_Link3" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <br />
                    </div>
                    <div style="margin-top: 5px; width: 205px">
                ...
                <div id="Div_part_library" runat="server" style="margin-left: 9px; width: 724px; margin-right: 9px; background-repeat: repeat-x">
                    <div style="margin-top: 5px; float: left; width: 505px; margin-right: 5px; text-align: right">
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_author" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_translator" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_isbn" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Link1_Book" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Link2_Book" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Library_password" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                        <br />
                    </div>
                    <div style="margin-top: 5px; width: 205px">
                ...
                <div id="Div_Part_speciallink" runat="server" style="margin-left: 9px; width: 724px; margin-right: 9px; background-repeat: repeat-x">
                    <div style="margin-top: 5px; float: left; width: 505px; margin-right: 5px; text-align: right">
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Speciallink" runat="server" CssClass="txtBox" MaxLength="255"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_Speciallink_Title" runat="server" CssClass="txtBox" MaxLength="255"></asp:TextBox>
                        </div>
                    </div>
                    <div style="margin-top: 5px; width: 205px">
                        <div style="width: 200px; height: 34px">
                ...
                <div
                    ...
                    <div id="Div3" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="fieldInputArea">
                                <asp:TextBox ID="Txt_news_source" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                ...
                <div id="Div_menu" runat="server" style="margin-left: 9px; width: 724px; margin-right: 9px; background-repeat: repeat-x">
                    <div style="margin-top: 5px; float: left; width: 505px; margin-right: 5px; text-align: right">
                        <div style="width: 480px; height: 34px" dir="ltr">
                            <asp:TextBox ID="Txt_menu_link" runat="server" CssClass="txtBox" MaxLength="255" Width="250px"></asp:TextBox>
                        </div>
                        <div style="width: 480px; height: 34px">
                            <asp:TextBox ID="Txt_menu_title" runat="server" CssClass="txtBox" MaxLength="255" Width="250px"></asp:TextBox>
                        </div>
                    </div>
                    <div style="margin-top: 5px; width: 205px">
                        <div style="width: 200px; height: 34px">
                ...
                <div
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <span dir="ltr">
                                <asp:TextBox ID="Txt_Link_Link" runat="server" CssClass="txtBox"></asp:TextBox>
                        </div>
                ...
                <div id="div_portal" runat="server">
                    ...
                    <div id="Div5" runat="server">
                      ...
                      <div id="div_estate" runat="server" visible="false" >
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:TextBox ID="estate_txt_address" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:TextBox ID="estate_txt_number" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:TextBox ID="estate_txt_zipCode" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        </div>
                    </div>
                        ...
                        <div class="fieldInputArea">
                            <asp:DropDownList ID="estate_ddl_agreement_type" runat="server" AutoPostBack="true"  OnSelectedIndexChanged="estate_ddl_agreement_type_SelectedIndexChanged">
                                <asp:ListItem Value="1" Text="فروش"></asp:ListItem>
                                <asp:ListItem Value="2" Text="رهن / اجاره"></asp:ListItem>
                            </asp:DropDownList>

                        </div>
                    </div>
                    <div id="estate_div_foroshPrices" runat="server" >
                        <div class="row">
                            <div class="field">
                                قیمت متری
                            </div>
                            <div class="fieldInputArea">
                                <asp:TextBox ID="estate_txt_meterPrice" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="fieldInputArea">
                                <asp:TextBox ID="estate_txt_totalPrice" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                            </div>
                        </div>
                    </div>

                   <div id="estate_div_rahnEjare"  runat="server" >
                        <div class="row">
                            <div class="field">
                                اجاره ماهیانه - ریال
                            </div>
                            <div class="fieldInputArea">
                                <asp:TextBox ID="estate_txt_VadiePrice" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="fieldInputArea">
                                <asp:TextBox ID="estate_txt_EjarePrice" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                              </ContentTemplate>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:DropDownList ID="estate_ddl_type" runat="server"></asp:DropDownList>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                                  <asp:DropDownList ID="estate_ddl_docType" runat="server">
                                <asp:ListItem Value="1" Text="-"></asp:ListItem>
                                <asp:ListItem Value="2" Text="مسکونی"></asp:ListItem>
                                <asp:ListItem Value="3" Text="اداری"></asp:ListItem>
                                <asp:ListItem Value="4" Text="تجاری"></asp:ListItem>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:TextBox ID="estate_txt_landlord_fname" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:TextBox ID="estate_txt_landlord_lname" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:TextBox ID="estate_txt_landlord_email" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:TextBox ID="estate_txt_landlord_tel" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:TextBox ID="estate_txt_landlord_cellPhone" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            ...
                            <asp:TextBox ID="estate_txt_metrazh" runat="server"  CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:TextBox ID="estate_txt_tedadeOtagh" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:TextBox ID="estate_txt_tabaghe" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:TextBox ID="estate_txt_tedadeTabaghat" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:TextBox ID="estate_txt_JameVahedHa" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            ...
                            <asp:TextBox ID="estate_txt_nama" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                                       ...
                                       <div class="fieldInputArea">
                                  <asp:DropDownList ID="estate_ddl_sokonatStatus" runat="server">
                                <asp:ListItem Value="1" Text="-"></asp:ListItem>
                                <asp:ListItem Value="2" Text="مالک"></asp:ListItem>
                                <asp:ListItem Value="3" Text="مستاجر"></asp:ListItem>
                                <asp:ListItem Value="4" Text="تخلیه"></asp:ListItem>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:TextBox ID="estate_txt_seneBana" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_bazsaziShode" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                                              <asp:TextBox ID="estate_txt_kabinet" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            ...
                            <asp:TextBox ID="estate_txt_wc" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        ...
                        <div class="fieldInputArea">
                            <asp:TextBox ID="estate_txt_kafpoosh" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:TextBox ID="estate_txt_tedadeParking" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:TextBox ID="estate_txt_tedadeTel" runat="server" CssClass="txtBox" MaxLength="49"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_anbari" runat="server" />
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_balkon" runat="server" />
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_OpenKitchen" runat="server" />
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_shoomine" runat="server" />
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            ...
                            <asp:CheckBox ID="estate_chk_shofazh" runat="server" />
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_chiler" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_FanCoil" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_packge" runat="server" />
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_cooler" runat="server" />
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_pool" runat="server" />
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_Sauna" runat="server" />
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_Jacuzzi" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_Elevator" runat="server" />
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_Barbecue" runat="server" />
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_VideoIPhone" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_CCTV" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_RemoteDoor" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_CentralAntenna" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_CentralInternet" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_Backyard" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_Landscape" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_Lobby" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_communitiesHall" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_watchMan" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_Patio" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_FireFighting" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="fieldInputArea">
                            <asp:CheckBox ID="estate_chk_wasteShoting" runat="server" />
                        </div>
                    </div>
            ...
            <DotNetAge:View Text="تصویر" runat="server" ID="View_picture">
                آپلود تصویر جدید:<br />
            ...
            <DotNetAge:View Text="گالری تصاویر" runat="server" ID="View_pictureGallery">
    
                <uc1:c_page_edit_pictureGalley runat="server" id="c_page_edit_pictureGalley" />

            </DotNetAge:View>

             <DotNetAge:View Text="کلیپ" runat="server" ID="View_clip">
    bbbbbbbb
            </DotNetAge:View>


              <DotNetAge:View Text="تور مجازی" runat="server" ID="View_tour">
                  <div class="adm-detail-title">آپلود تور جدید</div>
                                     
                  
                  <div class="adm-info-message">
لطفا فولدر _flash  را به صورت فایل zip آپلود نمایید
	</div>
		...
		<td class="adm-detail-content-cell-r" width="60%">
         ...
         <br />
                ...
                <asp:Button ID="Button1" runat="server" Text="Upload" OnClick="btnUploadTour_Click" />
         
                <asp:Literal ID="lt_tourFileName" runat="server"></asp:Literal>
         
                <asp:Literal ID="Literal4" runat="server"></asp:Literal>
         

            
          <!--  <span class="adm-input-file"><span>Add file</span>
                
                <input class="typefile adm-designed-file" name="IMAGE_ID" size="20" type="file"></span>-->
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <div dir="rtl" style="width: 100%;">
                            <div style="background-image: url(../core/themeCP/Bitrix/CssImage/toolbar/win2_bg.gif); width: 100%; background-repeat: repeat-x; height: 30px; text-align: left">
                                <div style="float: left; background-image: url(../core/themeCP/Bitrix/CssImage/toolbar/win2_left_bg.gif); width: 2px; height: 30px">
                                </div>
                                <div style="float: left; background-image: url(../core/themeCP/Bitrix/CssImage/toolbar/win2_spacer.gif); margin-left: 5px; width: 3px; margin-right: 5px; height: 30px">
                                </div>
                                <div style="float: right; background-image: url(../core/themeCP/Bitrix/CssImage/toolbar/win2_right_bg.gif); width: 2px; height: 30px">
                                </div>
                                                    ...
                                                    <div class="CPWin1tl">
                                                        <div class="CPWin1tr">
                                                            <div dir="rtl" style="text-align: right; line-height: 20px;">
                                                                ...
                                                                <div id="saleTerm_div_error_min" visible="false" runat="server" dir="rtl" style="border-right: red 2px solid; border-top: red 2px solid; border-left: red 2px solid; width: 100%; border-bottom: red 2px solid; text-align: right; margin-top: 10px">
                                                                    ...
                                                                    <div style="padding-right: 5px; margin-top: 5px; width: 313px; color: red; padding-top: 5px">
                                                                        اخطار!<br />
                                                                        <span style="font-size: 9pt">حداقل سفارش
                                                                            <asp:Label ID="sale_term_lbl_min_quantity_field" runat="server" Text="Label"></asp:Label>
                                                                            <asp:Label ID="sale_term_lbl_min_unit_field2" runat="server" Text="Label"></asp:Label>
                                                                            قبلا تعریف گردیده است!
                            ...
                            <div class="CPWin1t">
                                <div class="CPWin1b">
                                                    ...
                                                    <div class="CPWin1tl">
                                                        <div class="CPWin1tr">
                                                            <div dir="rtl" style="text-align: right; line-height: 20px;">
                                                                ...
                                                                <div id="saleTerm_edit_div_error_min" visible="false" runat="server" dir="rtl" style="border-right: red 2px solid; border-top: red 2px solid; border-left: red 2px solid; width: 100%; border-bottom: red 2px solid; text-align: right; margin-top: 10px">
                                                                    <div style="margin-top: 5px; float: right; width: 38px; height: 26px">
                                                                    ...
                                                                    <div style="padding-right: 5px; margin-top: 5px; width: 313px; color: red; padding-top: 5px">
                                                                        اخطار!<br />
                                                                        <span style="font-size: 9pt">حداقل سفارش
                                                                            <asp:Label ID="sale_term_edit_lbl_min_quantity_field" runat="server" Text="Label"></asp:Label>
                                                                            <asp:Label ID="sale_term_edit_lbl_min_unit_field2" runat="server" Text="Label"></asp:Label>
                                                                            قبلا تعریف گردیده است!
                                    ...
                                    <br />
                                                                ...
                                                                کد
                                                                <asp:Label ID="saleTerm_Edit_lbl_code" runat="server" Text="Label"></asp:Label><br />
                        ...
                        <div id="divDelSaleTerm" runat="server" dir="rtl" style="border-right: red 2px solid; border-top: red 2px solid; border-left: red 2px solid; width: 100%; border-bottom: red 2px solid; text-align: right; margin-top: 10px">
                            <div style="margin-top: 5px; float: right; width: 38px; height: 26px">
                            ...
                            <div style="padding-right: 5px; margin-top: 5px; width: 493px; color: red; padding-top: 5px">
                                ...
                                <span style="font-size: 9pt">برای حذف قانون فروش 
                                    <asp:Label ID="sale_term_del_lbl_id" runat="server" Text="Label"></asp:Label>
                                    مطمئن هستید؟
                                    <br />
                        ...
                        <div id="divOkSaleTerm" runat="server" dir="rtl" style="border-right: teal 2px solid; border-top: teal 2px solid; border-left: teal 2px solid; width: 100%; border-bottom: teal 2px solid; height: 45px; text-align: right; margin-top: 10px">
                            <div style="margin-top: 5px; float: right; width: 38px; margin-right: 10px; height: 26px">
                                <asp:Image ID="Image10" runat="server" ImageUrl="~/core/themeCP/Bitrix/CssImage/icon/msg2_icon1.gif" />&nbsp;
                            </div>
                            <div style="padding-right: 5px; margin-top: 5px; float: right; width: 493px; color: red; padding-top: 5px; height: 26px">
                                <span style="color: black">عملیات موفقیت آمیز<br />
                                    <span style="font-size: 9pt">مشخصات مورد نظر شما ثبت گردید.</span></span>
                        ...
                        <div dir="rtl" style="width: 550px;">
                            &nbsp;<asp:GridView ID="saleTerm_gv" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <EmptyDataTemplate>
                                    <div dir="rtl" style="border-right: red 2px solid; border-top: red 2px solid; border-left: red 2px solid; width: 100%; border-bottom: red 2px solid; height: 45px; text-align: right; border-style: none;">
                                        <div style="margin-top: 5px; float: right; width: 38px; height: 26px">
            ...
            <DotNetAge:View Text="سیکل پرداخت" runat="server" ID="View_paycycle" Visible="false">
                <asp:UpdatePanel ID="UpdatePanelCycle" runat="server">
                    <ContentTemplate>
                        ...
                        <div id="paycycle_div_MSG3" runat="server" dir="rtl" style="border-right: red 2px solid; border-top: red 2px solid; border-left: red 2px solid; width: 100%; border-bottom: red 2px solid; text-align: right; margin-top: 10px">
                            <div style="margin-top: 5px; float: right; width: 38px; height: 26px">
                                <asp:Image ID="Image1" runat="server" ImageUrl="~/core/themeCP/Bitrix/CssImage/icon/msg1_icon1.gif" />&nbsp;
                            </div>
                            <div style="padding-right: 5px; margin-top: 5px; width: 493px; color: red; padding-top: 5px">
                                اخطار!<br />
                        ...
                        <div id="paycycle_div_MSG2" runat="server" dir="rtl" style="border-right: teal 2px solid; border-top: teal 2px solid; border-left: teal 2px solid; width: 100%; border-bottom: teal 2px solid; height: 45px; text-align: right; margin-top: 10px">
                            <div style="margin-top: 5px; float: right; width: 38px; margin-right: 10px; height: 26px">
                                <asp:Image ID="Image3" runat="server" ImageUrl="~/images/msg2_icon1.gif" />&nbsp;
                            </div>
                            <div style="padding-right: 5px; margin-top: 5px; float: right; width: 493px; color: red; padding-top: 5px; height: 26px">
                                <span style="color: black">عملیات موفقیت آمیز<br />
                                    <span style="font-size: 9pt">مشخصات مورد نظر شما ثبت گردید.</span></span>
            ...
            <DotNetAge:View Text="فیلد های انتخابی" runat="server" ID="ViewFieldOptional">
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                                                                ...
                                                                <asp:GridView ID="gv_propDefVal" runat="server" AllowPaging="True"
                                                                    ...
                                                                    <Columns>
                                                                        <asp:BoundField DataField="core_prop_defVal_id"
                                                                            ...
                                                                            InsertVisible="False" ReadOnly="True" SortExpression="core_prop_defVal_id"></asp:BoundField>
                        ...
                        <div id="divPropDel" runat="server" dir="rtl" style="border-right: red 2px solid; border-top: red 2px solid; border-left: red 2px solid; width: 100%; border-bottom: red 2px solid; text-align: right; margin-top: 10px">
                            <div style="margin-top: 5px; float: right; width: 38px; height: 26px">
                        ...
                        <div id="divPropMsgOk" runat="server" dir="rtl" style="border-right: teal 2px solid; border-top: teal 2px solid; border-left: teal 2px solid; width: 100%; border-bottom: teal 2px solid; height: 45px; text-align: right; margin-top: 10px">
                            <div style="margin-top: 5px; float: right; width: 38px; margin-right: 10px; height: 26px">
                                <asp:Image ID="Image7" runat="server" ImageUrl="~/core/themeCP/Bitrix/CssImage/icon/msg2_icon1.gif" />&nbsp;
                            </div>
                            <div style="padding-right: 5px; margin-top: 5px; float: right; width: 493px; color: red; padding-top: 5px; height: 26px">
                                <span style="color: black">عملیات موفقیت آمیز<br />
                                    <span style="font-size: 9pt">مشخصات مورد نظر شما ثبت گردید.</span></span>
    ...
    <div id="btns" style="border-left: 1px solid #aaaaaa; border-right: 1px solid #aaaaaa; border-bottom: 1px solid #aaaaaa; padding: 10px; background-color: #f8f9fc; direction: rtl; border-top-color: #aaaaaa; border-top-width: 1px; margin-bottom: 10px; text-align: right;">
        <asp:Button ID="btnOK" ClientIDMode="Static" CssClass="adm-btn-save" runat="server"  
            OnClick="btnOK_Click"
