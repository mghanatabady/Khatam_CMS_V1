...
public partial class Manage_C_school_View_ClassGrade_linked_Parent : System.Web.UI.UserControl
{
...
+ " school_Lesson.unit, school_score_cat.title AS ScoreTypeTitle, users_A.id AS studentID, users_A.fname + ' ' + users_A.lname AS realname, "
+ " school_Score.baseOfScore"
...
+ " school_score_cat ON school_Score.score_type_type = school_score_cat.id INNER JOIN"
+ " users AS users_A ON school_Score.student_id = users_A.id INNER JOIN"
+ " school_StudentRefParent ON users_A.id = school_StudentRefParent.idStudent"
...
+ " school_Lesson_1.unit, school_score_cat_1.title AS ScoreTypeTitle, users_2.id AS studentID, users_2.fname + ' ' + users_2.lname AS realname, "
+ " school_Score_1.baseOfScore"
+ " FROM school_Score AS school_Score_1 INNER JOIN"
+ " school_score_cat AS school_score_cat_1 ON school_Score_1.score_type_type = school_score_cat_1.id INNER JOIN"
