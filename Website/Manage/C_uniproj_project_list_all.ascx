<%@ Control Language="C#" AutoEventWireup="true" CodeFile="C_uniproj_project_list_all.ascx.cs" Inherits="Manage_C_uniproj_project_list_all" %>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <asp:ImageButton ID="btn_small_edit" runat="server" 
                                                ...
                                                <asp:ImageButton ID="btn_small_del" runat="server" 
                                                    ...
                                                    RowIndex="<%# Container.DisplayIndex %>" Text="تایید پروژه" Visible="False"  />
