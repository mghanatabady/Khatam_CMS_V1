<%@ Control Language="VB" AutoEventWireup="false" CodeFile="c_school_teacher_del.ascx.vb" Inherits="c_school_teacher_del" %>
...
<div id="MSG3" runat="server" dir="rtl" style="border-right: red 2px solid; border-top: red 2px solid;
    ...
    <div style="padding-right: 5px; margin-top: 5px; float: right; width: 493px; color: red;
        padding-top: 5px">
        اخطار!<br />
        <span style="font-size: 9pt">با حذف معلم علاوه بر حذف اطلاعات، &nbsp;صفحه اختصاصی و
            فایل هایی که معلم بر روی سایت قرارداده اند &nbsp;نیز حذف خواهد شد. آیا برای
            حذف معلم مطمئن هستید؟<br />
            <br />
...
<div id="Div1" runat="server" dir="rtl" style="border-right: teal 2px solid; border-top: teal 2px solid;
...
<br />
<div dir="rtl" style="margin-left: 10px; width: 742px; margin-right: 10px; text-align: right;" id="Div2" runat="server">
    <asp:GridView ID="GridView3" runat="server" AllowPaging="True" AllowSorting="True"
        ...
        DataSourceID="SqlDataSource3" PageSize="50" Width="742px" DataKeyNames="school_Student_id">
        <Columns>
            <asp:BoundField DataField="school_student_id" HeaderText="شماره دانش آموزی" SortExpression="school_student_id" />
            <asp:BoundField DataField="school_course_personal_id" HeaderText="کد ارائه" SortExpression="school_course_personal_id" />
            <asp:BoundField DataField="school_Student_id" HeaderText="کد دانش آموز" ReadOnly="True"
                SortExpression="school_Student_id" />
            <asp:BoundField DataField="realname" HeaderText="نام دانش آموز" ReadOnly="True" SortExpression="realname" />
        </Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Khatam_site %>"
        SelectCommand="SELECT school_course_personal_student.school_student_id, school_course_personal_student.school_course_personal_id, school_Student.Fname + ' ' + school_Student.Lname AS realname FROM school_Student INNER JOIN school_course_personal_student ON school_Student.id = school_course_personal_student.school_student_id INNER JOIN school_course_personal ON school_course_personal_student.school_course_personal_id = school_course_personal.id WHERE (school_course_personal.id = @school_course_personal_id)">
        <SelectParameters>
            <asp:QueryStringParameter Name="school_course_personal_id" QueryStringField="id" />
        </SelectParameters>
    </asp:SqlDataSource>
</div>
<br />
