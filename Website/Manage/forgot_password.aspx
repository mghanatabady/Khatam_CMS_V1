<%@ Page Language="C#" AutoEventWireup="true" CodeFile="forgot_password.aspx.cs" Inherits="Manage_forgot_password" %>
...
<div class="bx-auth-header"><%= PasswordRecovery%> 

    <a href="<%= khatam.core.strings.Url.ApplicationPaths.FullyQualifiedApplicationPath%>manage/forgot_password.aspx?lang=fa-IR"> 
<img src="../core/themeCP/Bitrix/CssImage/Lang/FA.gif" style="border-width: 0px"  /></a>
    <a href="<%= khatam.core.strings.Url.ApplicationPaths.FullyQualifiedApplicationPath%>manage/forgot_password.aspx?lang=en-US"> 
    <img src="../core/themeCP/Bitrix/CssImage/Lang/en.gif" style="border-width: 0px" /></a>
    <a href="<%= khatam.core.strings.Url.ApplicationPaths.FullyQualifiedApplicationPath%>manage/forgot_password.aspx?lang=ar-AE">  
...
<table class="data-table bx-auth-table" id="table">
	<thead>
		<tr>
