<%@ Control Language="C#" AutoEventWireup="true" CodeFile="c_forms.ascx.cs" Inherits="Manage_c_forms" %>
...
<div id="msgAdd" runat="server" >
    ...
    <div class="CPWin1t"><div class="CPWin1b"><div class="CPWin1l"><div class="CPWin1r"><div class="CPWin1bl"><div class="CPWin1br"><div class="CPWin1tl"><div class="CPWin1tr">
                                  <div dir="rtl" style="text-align: right">
                                     ...
                                     عنوان
                                  <br />
                                          <asp:TextBox ID="txtTitle" runat="server" MaxLength="49" CssClass="txtBox"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
        ControlToValidate="txtTitle" ErrorMessage="*" ValidationGroup="aaa">*</asp:RequiredFieldValidator>
                                      <br />
                                      <br />

                                           شرح
                                  <br />
                                          <asp:TextBox ID="txtDescription"  runat="server" MaxLength="49" 
                                          CssClass="txtBox" Height="58px" TextMode="MultiLine" Width="336px"></asp:TextBox>
                                          <br />
                                      <br />
              ...
              <div class="CPWin1t_bb"><div class="CPWin1b_bb"><div class="CPWin1l_bb"><div class="CPWin1r_bb"><div class="CPWin1bl_bb"><div class="CPWin1br_bb"><div class="CPWin1tl_bb"><div class="CPWin1tr_bb">
               ...
               <asp:Button ID="btnFromAdd" CssClass="Cpbtn" runat="server" Text="تایید" 
                      onclick="btnFromAdd_Click" />
  ...
  <div id="msgEdit" runat="server" >
    ...
    <div class="CPWin1t"><div class="CPWin1b"><div class="CPWin1l"><div class="CPWin1r"><div class="CPWin1bl"><div class="CPWin1br"><div class="CPWin1tl"><div class="CPWin1tr">
                                  ...
                                  <br />
                                     ...
                                     عنوان
                                  <br />
                                          <asp:TextBox ID="txt_edit_title" runat="server" MaxLength="49" CssClass="txtBox"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
        ControlToValidate="txt_edit_title" ErrorMessage="*" ValidationGroup="bbb">*</asp:RequiredFieldValidator>
                                      <br />
                                      <br />

                                           شرح
                                  <br />
                                          <asp:TextBox ID="txt_edit_Description"  runat="server" MaxLength="49" 
                                          CssClass="txtBox" Height="58px" TextMode="MultiLine" Width="336px"></asp:TextBox>
                                          <br />
                                      <br />
              ...
              <div class="CPWin1t_bb"><div class="CPWin1b_bb"><div class="CPWin1l_bb"><div class="CPWin1r_bb"><div class="CPWin1bl_bb"><div class="CPWin1br_bb"><div class="CPWin1tl_bb"><div class="CPWin1tr_bb">
               ...
               <asp:Button ID="Button1" CssClass="Cpbtn" runat="server" ValidationGroup="bbb" Text="تایید" 
...
<asp:Button ID="Button6" CssClass="Cpbtn" runat="server" Text="انصراف" onclick="BtnCancel_Click" />
  ...
  <div id="MSG3" runat="server" dir="rtl" style="border-right: red 2px solid; border-top: red 2px solid;
    ...
    <div style="padding-right: 5px; margin-top: 5px;  width: 493px; color: red;
        padding-top: 5px">
        اخطار!<br />
        <span style="font-size: 9pt">با عمل حذف تمام مشخصات مرتبط با فرم نیز حذف خواهد 
        گردید، آیا برای عملیات حذف فرم شماره 
...
<div  dir="rtl"  style=" width: 100%;   ">
    &nbsp;<asp:GridView 
        ...
        DataKeyNames="form_id" DataSourceID="SqlDataSource2" PageSize="50" 
        ...
        <Columns>
            <asp:BoundField DataField="form_id" HeaderText="کد" InsertVisible="False" 
                ReadOnly="True" SortExpression="form_id" HeaderStyle-HorizontalAlign="Right" >
            <HeaderStyle HorizontalAlign="Right" />
            </asp:BoundField>
            <asp:BoundField DataField="form_name" HeaderText="عنوان" SortExpression="form_name" 
                HeaderStyle-HorizontalAlign="Right" >
            <HeaderStyle HorizontalAlign="Right" />
            </asp:BoundField>
     
             <asp:ButtonField Text="نتایج" CommandName="entries" />
            <asp:ButtonField Text="ویرایش فیلد ها" CommandName="editField" />
            <asp:ButtonField Text="ایمیل ها" CommandName="email"  Visible="false"/>
            <asp:ButtonField Text="sms" CommandName="sms" Visible="false" />
            <asp:ButtonField Text="کد فرم" CommandName="code"  Visible="false" />
             <asp:ButtonField Text="ویرایش" CommandName="editcom" />
