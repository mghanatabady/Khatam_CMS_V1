...
public partial class Manage_C_portals_my_orders : System.Web.UI.UserControl
{
...
" WHERE     (core_invoice_line.type_content = N'portal') AND (core_invoice.users_id = " + khatam.core.Security.Users.login() + ") " + ViewState["strWhere"] + ViewState["strOrderBy"];
