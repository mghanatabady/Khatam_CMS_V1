<%@ Control Language="C#" AutoEventWireup="true" CodeFile="C_darman_cards_manage.ascx.cs" Inherits="Manage_C_darman_cards_manage" %>
...
<div id="msgAdd" runat="server"  style=" width:100% ;  " >
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
        ControlToValidate="add_txt_title" ErrorMessage="*" ValidationGroup="aaa">*</asp:RequiredFieldValidator>
                                      <br />
                                      <br />

                                                                           قیمت ریالی
                                  <br />
                                          <asp:TextBox ID="add_txt_price_rls" runat="server" MaxLength="49" CssClass="txtBox"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
        ControlToValidate="add_txt_price_rls" ErrorMessage="*" ValidationGroup="aaa">*</asp:RequiredFieldValidator>
                                      <asp:RangeValidator ID="RangeValidator1" runat="server"  ControlToValidate="add_txt_price_rls"  ErrorMessage="*" MinimumValue="1000" MaximumValue="999999999" Type="Integer" ValidationGroup="aaa"></asp:RangeValidator>
...
<asp:Button ID="Button3" CssClass="Cpbtn" runat="server" Text="انصراف" onclick="BtnCancel_Click" />
  ...
  <div id="msgEdit" runat="server" >
    ...
    <div class="CPWin1t"><div class="CPWin1b"><div class="CPWin1l"><div class="CPWin1r"><div class="CPWin1bl"><div class="CPWin1br"><div class="CPWin1tl"><div class="CPWin1tr">
                        ...
                        عنوان
                                  <br />
                                          <asp:TextBox ID="edit_txt_title" runat="server" MaxLength="49" CssClass="txtBox"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
        ControlToValidate="edit_txt_title" ErrorMessage="*" ValidationGroup="bbb">*</asp:RequiredFieldValidator>
                                      <br />
                                      <br />

                                                                           قیمت ریالی
                                  <br />
                                          <asp:TextBox ID="edit_txt_price_rls" runat="server" MaxLength="49" CssClass="txtBox"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
        ControlToValidate="edit_txt_price_rls" ErrorMessage="*" ValidationGroup="bbb">*</asp:RequiredFieldValidator>
                                      <asp:RangeValidator ID="RangeValidator2" runat="server"  ControlToValidate="edit_txt_price_rls"  ErrorMessage="*" MinimumValue="1000" MaximumValue="999999999" Type="Integer" ValidationGroup="bbb"></asp:RangeValidator>
              ...
              <div class="CPWin1t_bb"><div class="CPWin1b_bb"><div class="CPWin1l_bb"><div class="CPWin1r_bb"><div class="CPWin1bl_bb"><div class="CPWin1br_bb"><div class="CPWin1tl_bb"><div class="CPWin1tr_bb">
               ...
               <asp:Button ID="Button1" CssClass="Cpbtn" runat="server" Text="تایید" 
                      onclick="Button1_Click"  ValidationGroup="bbb" />
...
<div  dir="rtl"  style=" width: 100%;   ">
    &nbsp;<asp:GridView 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="price_rls" HeaderText="قیمت ریالی" />
...
<asp:SqlDataSource ID="SqlDataSource2" runat="server" 
    ...
    SelectCommand="SELECT  [id]      ,[title]      ,[price_rls]  FROM [darman_cards_type]" >
</asp:SqlDataSource>
