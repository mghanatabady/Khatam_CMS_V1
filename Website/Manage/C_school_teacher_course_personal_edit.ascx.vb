...
Partial Class C_school_teacher_course_personal_edit
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (pAll = False) Then
            ...
            If (khatam.School.teacher.ValidCoursePersonalRelatedTeacher(Request.QueryString("id")) = False) Then
                Me.Response.Redirect("~/manage/?mode=msgPermisson")
            End If
        End If
        ...
        SqlDataSource1.SelectCommand = "       SELECT     users.id, users.fname, users.lname, users.lname + ' , ' + users.fname AS realname " +
" FROM         school_course_personal_student INNER JOIN " +
                      " users ON school_course_personal_student.school_student_id = users.id " +
        " WHERE (school_course_personal_student.school_course_personal_id = " + Me.Request.QueryString("id") + " )  "
 ...
 "                     school_Score.school_course_personal " +
"FROM         school_Score INNER JOIN " +
 "                     school_course_personal ON school_Score.school_course_personal = school_course_personal.id " +
"WHERE     (school_course_personal.id = " + Me.Request.QueryString("id") + ") AND (school_Score.score_cat_id = N'0')  "
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        For i = 0 To Me.GridView1.Rows.Count - 1
            ...
            For j = 1 To 5
                ...
                Me.GridView3.DataBind()
                If score_Check_identity(score_type_type, Me.Label1.Text, student_id) = True Then
                    If value = "" Then GoTo 10
                    Score_add(value, "", score_type_type, Me.Label1.Text, student_id)
                    c_add = c_add + 1
                Else
                    ...
                    If value <> "" Then
                        ...
                        c_edit = c_edit + 1
                    Else
                        Score_delete(score_type_type, Me.Label1.Text, student_id)
                        c_del = c_del + 1
                    End If
...
10:
    ...
    Private Sub old_score_set_fro()
        ...
        For scoreitemi = 0 To Me.GridView1.Rows.Count - 1
            ...
            ConfigurationManager.ConnectionStrings("Khatam_Site").ConnectionString
    ...
    Private Sub Score_add(ByVal value As String, ByVal score_cat_id As String, ByVal score_type_type As String, ByVal classroom_select As String, ByVal student_id As String)
        ...
        " (value, score_cat_id, score_type_type, school_course_personal, student_id) " & _
        " VALUES     (@value,@score_cat_id,@score_type_type,@school_course_personal,@student_id)"
