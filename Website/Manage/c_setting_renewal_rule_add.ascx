        <link rel="stylesheet" type="text/css" href="../build/Khatam_Panel.css" />

<%@ Control Language="VB" AutoEventWireup="false" CodeFile="c_setting_renewal_rule_add.ascx.vb" Inherits="manage_setting_renewal_rule_add" %>
<br />
...
<div dir="rtl" style="margin-left: 10px; width: 742px; margin-right: 10px; font-size: 12pt;">
    <div style="background-image: url(../images/manage/form1_bg.gif); width: 742px; background-repeat: repeat-x;
        ...
        <div id="test" style="margin-top: 9px; float: left; background-image: url(../images/manage/Tab1_bg.gif);
            ...
            <div style="margin-top: 2px; float: left; width: 100px; height: 20px; text-align: center; font-size:9pt">
                سفارش جدید</div>
        ...
        <div style="margin-left: 9px; width: 724px; margin-right: 9px; background-repeat: repeat-x">
            <div style="margin-top: 5px; float: left; width: 395px; margin-right: 5px; text-align: right">
                <div class="from_div_title">
                    <asp:TextBox ID="Txt_Code" runat="server" CssClass="from_txt" MaxLength="19" 
                        BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox></div>
                <div class="from_div_title">
                    <asp:TextBox ID="Txt_type" runat="server" CssClass="from_txt" MaxLength="19" 
                        BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox></div>
                <div class="from_div_title">
                    <asp:TextBox ID="Txt_title" runat="server" CssClass="from_txt"></asp:TextBox>
                </div>
                <div class="from_div_title">
                    <asp:DropDownList ID="DDL_year" runat="server" Font-Names="Tahoma" 
                        Width="65px">
                ...
                <div class="from_div_title">
                    <asp:TextBox ID="Txt_Value" runat="server" CssClass="from_txt"></asp:TextBox>
                </div>
