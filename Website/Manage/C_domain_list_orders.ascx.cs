...
public partial class Manage_C_domain_list_orders : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {        
        Label c = (Label)this.Parent.FindControl("lblMainTitle");
        c.Text = "دامین: لیست سفارشات مشتریان";
        ...
        l.Text = l.Text + " دامین: لیست سفارشات مشتریان";
        l.Text = l.Text + "</span> ";
    ...
    void gridBind()
    {
      string   sqlstr = "SELECT     core_invoice_line.id, core_invoice_line.invoice_id, core_invoice_line.price, core_invoice_line.title, core_invoice_line.quantity, core_invoice_line.sum, " +
            ...
            " WHERE     (core_invoice_line.type_content = N'domain') " + ViewState["strWhere"] + ViewState["strOrderBy"];
