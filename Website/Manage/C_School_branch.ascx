<%@ Control Language="VB" AutoEventWireup="false" CodeFile="C_School_branch.ascx.vb" Inherits="C_School_branch" %>
<br />
...
<div dir="rtl" style="margin-left: 10px; width: 742px; margin-right: 10px; text-align: right">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="title" HeaderText="نام رشته" ReadOnly="True" SortExpression="title" />
            <asp:CommandField SelectText="ویرایش" ShowSelectButton="True" Visible="False" />
            <asp:ButtonField CommandName="group_del" Text="حذف" Visible="False" />
        </Columns>
        <FooterStyle BackColor="#F1F3FA" />
        <HeaderStyle BackColor="#F1F3FA" BorderColor="#BDC6E0" />
    </asp:GridView>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        SelectCommand="SELECT id, title FROM school_branch WHERE (id <> N'99')"></asp:SqlDataSource>
</div>
