<%@ Control Language="VB" AutoEventWireup="false" CodeFile="c_school_teacher_course_edit.ascx.vb" Inherits="c_school_teacher_course_edit" %>
<br />
        ...
        <div style="margin-left: 9px; width: 724px; margin-right: 9px; background-repeat: repeat-x">
            ...
            <div style="width: 720px; text-align: justify;" dir="rtl">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1"
                    ...
                    <EmptyDataTemplate>
                        دانش آموزشی برای این کلاس یافت نشد
                    </EmptyDataTemplate>
                </asp:GridView>
                ...
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                    DataSourceID="SqlDataSource1" DataKeyNames="id" Visible="False">
                    <Columns>
