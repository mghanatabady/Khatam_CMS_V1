<%@ Control Language="C#" AutoEventWireup="true" CodeFile="C_school_View_reportCard_linked_student.ascx.cs" Inherits="Manage_C_school_View_reportCard_linked_student" %>
